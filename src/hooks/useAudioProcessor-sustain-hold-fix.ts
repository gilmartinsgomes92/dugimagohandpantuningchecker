      ...
      const tick = () => {
        ...
        if (rms >= dynamicGate) {
          ...
          if (match !== null) {
            ...
            const stableCFifth = finalizeStableFrequency(cFifthFramesRef.current, MIN_PARTIAL_FRAMES, 16);
