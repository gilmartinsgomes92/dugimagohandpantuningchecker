...
const PARTIAL_LOCK_WINDOW_MS = 220;
const PARTIAL_REFINE_WINDOW_MS = 1100;

const MIN_OCTAVE_FRAMES = 3;
const MAX_OCTAVE_FRAMES = 18;
const MIN_CFIFTH_FRAMES = 3;
const MAX_CFIFTH_FRAMES = 18;

const OCTAVE_MAX_MAD_CENTS = 14;
const CFIFTH_MAX_MAD_CENTS = 18;
