...
const WIDE_OCTAVE_WINDOW_CENTS = 160;
          ...
          if (match !== null) {
            ...
            if (freq !== null) {
              ...
              if (shouldTrackPartials) {
                const octaveFft = findHarmonicFrequency(
                  freqBufRef.current,
                  octaveNominal,
                  sampleRate,
                  analyserRef.current.fftSize,
                ...
                const refinedOctave = chooseBestPartialCandidate(
                  octaveFft !== null && isRatioValid(octaveFft, smoothedFreq, 'octave') ? octaveFft : null,
                  octaveTime,
                  octaveNominal,
                );
