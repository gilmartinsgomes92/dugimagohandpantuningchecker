            ...
            {result.frequency !== null ? (
              <>
                ...
                <div style={{ marginTop: '1rem' }}>
                  <div className="reading-row">
                    <span className="reading-label">Fundamental</span>
                    <span className="reading-value" style={{ color: liveFundamentalColor }}>
                      {liveFundamentalCents !== null ? formatCents(liveFundamentalCents) : '—'}
                    </span>
                  </div>
                  <div className="reading-row">
                    <span className="reading-label">Octave</span>
                    <span className="reading-value" style={{ color: liveOctaveColor }}>
